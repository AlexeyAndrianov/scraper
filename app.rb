...
class PageParser
  ...
  # парсим все URL продуктов и для каждого продукта вызываем метод,
  # который пропарсит вариации товара (parse_multiproducts)
...
puts 'Input URL:'
puts 'url example = https://www.petsonic.com/snacks-huesos-para-perros/'
url = gets.chomp

puts "Input file's name with results:"
puts 'file_name example = test.csv'
file_name = gets.chomp

parser = PageParser.new(url, file_name)
parser.parse
